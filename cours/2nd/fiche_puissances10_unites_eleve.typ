...
#définition[
  *Règle pour un calcul:* Le résultat d'un calcul a autant de CS que la donnée #blanc(w: 4.4cm).
]

#exemple[
  Calculer 2,5 × 3,678. #linebreak()
  Calculatrice : 2,5 × 3,678 = 9,195 #linebreak()
  Donnée la moins précise : 2,5 (2 CS) → *résultat arrondi à 2 CS :* #blanc(w: 1.6cm)
]
...
#important[
  *La touche $times 10^x$ de la calculatrice.* Quand une donnée est écrite avec une puissance de 10 (ex : 3,2 × $10^(-3)$), on la saisit avec la touche *$times 10^x$* (parfois notée *EXP*) de la calculatrice — jamais en tapant séparément "×10" puis "^". #linebreak()
  Sur l'écran, le résultat peut s'afficher avec un *E* : par exemple *1.5E-3* signifie #blanc(w: 2.8cm). Il faut traduire ce "E" en écriture scientifique, jamais le recopier tel quel.
]
